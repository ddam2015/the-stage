<?php
  ...
  switch($post_type){
    case 'add_fav' : tscircuit_g365_data_xfer(['db_tb'=>'favorites', 'insert_field_val'=>fav_insert(['pl_id'=>$pl_id, 'pl_note'=>$pl_note, 'pl_name'=>$pl_name, 'pl_nickname'=>$pl_nickname, 'pl_img'=>$pl_img, 'pl_grad_year'=>$pl_grad_year, 'pl_position'=>$pl_position, 'pl_height'=>$pl_height, 'pl_gpa'=>$pl_gpa, 'pl_sat'=>$pl_sat, 'pl_contact_info'=>$pl_contact_info], 'fav_insert')], 'INSERT');
      break;
    case 'remove_fav': tscircuit_g365_data_xfer(['db_tb'=>'favorites', 'rec_id'=>$rec_id], 'DELETE');
      break;
  }
?>