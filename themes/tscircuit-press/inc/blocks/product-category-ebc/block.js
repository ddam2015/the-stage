 ...
 */
class ProductByCategoryBlocktscircuit extends Component {
	static propTypes = {
		/**
	...
	renderEditMode() {
		...
		return (
			<Placeholder
				icon="category"
				label={ __(
					'Products by Category tscircuit',
					'woocommerce'
				) }
...
export default withSpokenMessages( ProductByCategoryBlocktscircuit );
